...
class VentanaPreguntas(tk.Tk):
    def __init__(self, preguntas):
        ...
        random.shuffle(self.preguntas)  # Mezclar las preguntas aleatoriamente
    ...
    def crear_widgets(self):
        ...
        fuente_pregunta = ('Arial', 34)  # Fuente para las preguntas
        fuente_boton = ('Arial', 32)  # Fuente para los botones
